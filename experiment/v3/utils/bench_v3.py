"""
bench_v3.py — Per-GPU GPU-side timestamp collector for V3 benchmarking.
...
Caller contract:
  1. Construct BenchTimer(ctx, label) AFTER VulkanContextV3 is built.
  ...
  4. ``destroy()`` before VulkanContextV3.destroy().
"""
