"""
bench_v2.py — Per-GPU GPU-side timestamp collector for V2 benchmarking.
...
Caller contract:
  1. Construct BenchTimer(ctx, label) AFTER VulkanContextV2 is built.
  ...
  4. ``destroy()`` before VulkanContextV2.destroy().
"""
