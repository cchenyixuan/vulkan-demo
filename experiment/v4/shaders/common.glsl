...
//   47       : V4 correction interior/boundary mode (CORRECTION_MODE)
...
// V4 correction interior/boundary split (see docs/sph_v4_design.md §7).
...
// V4 Path A+ density interior/boundary split. Same tri-state semantics as
...
// V4 Path A+ force interior/boundary split. Same tri-state semantics, applied
...
// V4 boundary-band thickness in x-columns (see docs/sph_v4_design.md §7).
...
// --- V4 pipeline mode values (shared by CORRECTION_MODE / DENSITY_MODE /
...
// ----------------------------------------------------------------------------
// PoolHealthBuffer (binding 1) — V4 own-pool occupancy watermark.
//
...
// by ANY kernel — removed in V4 to keep set 3 compact. Re-add at a fresh
